...
- ⛅ [Elsendo](https://github.com/ymolodtsov/elsendo), a minimalist Markdown note-taking with sharing (based on Flow).
- 👩‍💻 [Marquee](https://github.com/ymolodtsov/marquee), blazing-fast and simple code editor for quick review. 
