...
- 📖 [Marble Reader](https://chromewebstore.google.com/detail/marble-reader/abpjefdalncpgpcoegimeheihgoibcgk?authuser=0&hl=en), a Safari-like Reading mode for Google Chrome and Chromium-based browsers
- ⌚ [Timezones](https://time.molodtsov.me), a command line for timezones
...
- 📬 [Freehold](https://freehold.molodtsov.me/), A Micropub client for the open web
- 👩‍💻 [Marquee](https://github.com/ymolodtsov/marquee), a fully-native Mac code editor for quick review
- 💠 [Strata](https://github.com/ymolodtsov/strata), a native outliner for Mac
